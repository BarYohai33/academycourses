...
class Home extends React.Component {
  ...
  render() {
    ...
    <div className={classes.container}>
      ...
      <h1 className={classes.centered} id="Offers" style={{fontFamily:'Dancing Script',fontSize:'50px'}} > Nos offres </h1>
        <Grid container spacing={40} alignItems='flex-end'>
          <Pricing
          coursetype="Cours particuliers"
          to="Adapté au rythme de l'élève"
          discover="Nos cours particuliers"/>
          <Pricing
          coursetype="Cours en ligne"
          to="En visioconférence"
          discover="Nos cours en ligne"/>
          <Pricing
          coursetype="Cours en groupe"
          to="Stage intensif"
          discover="Nos cours en groupe"/>
        </Grid>
      </div>
      <hr width="30%" style={{marginTop:'30px'}}/>
      <h1 className={classes.centered} style={{fontFamily:'Dancing Script',fontSize:'50px'}}> Contactez nous</h1>
        <div style={{width:'80%', height:'300px', backgroundColor:'#e6e6e6',margin:'auto'}}> 
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24"><path d="M0 0h24v24H0z" fill="none"/><path d="M20 15.5c-1.25 0-2.45-.2-3.57-.57-.35-.11-.74-.03-1.02.24l-2.2 2.2c-2.83-1.44-5.15-3.75-6.59-6.58l2.2-2.21c.28-.27.36-.66.25-1.01C8.7 6.45 8.5 5.25 8.5 4c0-.55-.45-1-1-1H4c-.55 0-1 .45-1 1 0 9.39 7.61 17 17 17 .55 0 1-.45 1-1v-3.5c0-.55-.45-1-1-1zM12 3v10l3-3h6V3h-9z"/></svg>
          </div>
          <div style={{textAlign:'center'}}>
          <Button style={{marginTop:'10px'}} variant="contained" color="primary" className={classes.button}>
          <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24"><path fill="none" d="M0 0h24v24H0V0z"/><path d="M4 4h16v12H5.17L4 17.17V4m0-2c-1.1 0-1.99.9-1.99 2L2 22l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2H4zm2 10h12v2H6v-2zm0-3h12v2H6V9zm0-3h12v2H6V6z"/></svg>
          <div style={{marginLeft:'4px',marginBottom:'2px'}}>Envoyez un message</div>
          </Button>
          </div>
           <div style={{textAlign:'center'}}>
          <Button style={{marginTop:'10px'}} variant="contained" color="default" className={classes.button}>
          <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24"><path d="M0 0h24v24H0z" fill="none"/><path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/></svg>
          <div style={{marginLeft:'4px',marginBottom:'2px'}}>Appelez nous par téléphone</div>
          </Button>
          </div>
           <div style={{textAlign:'center'}}>
          <Button style={{marginTop:'10px'}} variant="contained" color="default" className={classes.button}>
          <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24"><path d="M0 0h24v24H0z" fill="none"/><path d="M12 7V3H2v18h20V7H12zM6 19H4v-2h2v2zm0-4H4v-2h2v2zm0-4H4V9h2v2zm0-4H4V5h2v2zm4 12H8v-2h2v2zm0-4H8v-2h2v2zm0-4H8V9h2v2zm0-4H8V5h2v2zm10 12h-8v-2h2v-2h-2v-2h2v-2h-2V9h8v10zm-2-8h-2v2h2v-2zm0 4h-2v2h2v-2z"/></svg>
